"use strict";
// This script will be used to seed the database with dummy data. 
...
var supabase_1 = require("../app/src/lib/supabase");
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        console.log("Inserted ".concat(data.length, " records into artist_submissions."));
                    }
